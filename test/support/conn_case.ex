defmodule StreamClosedCaptionerPhoenixWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use StreamClosedCaptionerPhoenixWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = StreamClosedCaptionerPhoenix.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = StreamClosedCaptionerPhoenix.Accounts.generate_user_session_token(user)
