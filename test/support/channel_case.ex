defmodule StreamClosedCaptionerPhoenixWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use StreamClosedCaptionerPhoenixWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import StreamClosedCaptionerPhoenixWeb.ChannelCase
