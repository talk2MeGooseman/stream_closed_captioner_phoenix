defmodule StreamClosedCaptionerPhoenixWeb.Admin.StreamSettingsLive.Index do
  ...
  def render(assigns) do
    ...
    <.admin_table id="stream-settings-table" rows={@records} row_id={fn r -> "stream-settings-#{r.id}" end}>
    ...
    <%= if @live_action in [:new, :edit] do %>
      <.admin_modal id="stream-settings-form-modal" show={true} on_cancel={JS.patch(~p"/admin/stream-settings")}>
        <.live_component
